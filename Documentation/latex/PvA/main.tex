...
\fancyhead[R]{}
\fancyhead[L]{}
\fancyheadoffset[L]{0.8cm}
\fancyheadoffset[R]{1.2cm}
\headsep 40pt
...
%%% Title and Author %%%
\newcommand{\thistitle}{Hazeu Orchids - Orchids Packing Automation \\ \large Plan van Aanpak}
\author{}
\title{\thistitle}
\date{\today}
\newcommand{\version}{V0.1}
\fancyhead[C] {\color{textgray}\thistitle \space- \version\space - \today}
\lhead{\includegraphics[height=1.2cm]{Afbeeldingen/logosmal.jpg}}
\rhead{\includegraphics[width=4cm]{Afbeeldingen/hhs_eng_groen_fc.png}}
...
\begin{document}
	...
	\input{Projectgrenzen.tex}

	\input{projectactiviteit.tex}

	\input{Projectresultaten.tex}
	
	\input{IO-diagram.tex}
